...
Intel (Hur processorer fungerar) - https://www.intel.com/content/www/us/en/gaming/resources/how-processors-work.html

AMD (Ryzen-processorer och produktöversikt) - https://www.amd.com/en/products/ryzen-processors

TechPowerUp (Omfattande CPU-databas) - https://www.techpowerup.com/cpudb/

GamersNexus (Teknisk genomgång av CPU-tester) - https://www.youtube.com/watch?v=vVbcshM_3As

CPUID (CPU-Z mjukvara för processorinformation) - https://www.cpuid.com/softwares/cpu-z.html

Tom’s Hardware (CPU-hierarki och prestandatester) - https://www.tomshardware.com/reviews/cpu-hierarchy,4312.html

Linus Tech Tips (CPU-grunder och förklaringar) - https://www.youtube.com/watch?v=cNN_tTXABUA

Wikipedia (Central Processing Unit - CPU) - https://en.wikipedia.org/wiki/Central_processing_unit
...
---
**Nästa kapitel:** [1.3 RAM (Arbetsminne)](01.03_RAM_Arbetsminne.md)