...
Spegling (mirroring). Varje disk har en exakt kopia. Om en disk går sönder tar den andra över. Fördelen här är att du direkt har en kopia av den skadade filen, som ersätts utan attanvändaren knappt märker det.
...
Viktigt! RAID är inte en backup. Det skyddar mot diskkrasch, inte mot radering, virus eller brand.
