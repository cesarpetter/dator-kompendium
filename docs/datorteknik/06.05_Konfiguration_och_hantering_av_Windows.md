---
layout: default
title: "6.5 Konfiguration och hantering av Windows"
parent: "Datorteknik"
nav_order: 605
---
...
Lokala användare- och grupphantering (lusrmgr.msc) – i Pro-versioner för att mer avancerat skapa, ändra eller ta bort konton och grupper.
...
Vad är den primära skillnaden mellan ett standardanvändarkonto och ett administratörskonto i Windows när det gäller systemförändringar?

Hur används grupper för att effektivisera hanteringen av rättigheter för många användare samtidigt på en arbetsplats?

Vad innebär det rent praktiskt att rättigheter "ärvs" (Inheritance) i en mappstruktur?

Beskriv hur du i det grafiska gränssnittet (Egenskaper -> Säkerhet) kontrollerar och ändrar rättigheter på en specifik fil eller mapp.

Ge exempel på tre inbyggda Windows-verktyg som används för felsökning eller underhåll och beskriv kort vad de används till.

Vad är User Account Control (UAC) och varför är det en viktig säkerhetsfunktion även för användare som är administratörer?

Varför anses det vara en säkerhetsrisk att använda ett administratörskonto för vardagliga sysslor som att surfa på webben eller läsa e-post?

Vilket verktyg (snap-in) använder du i Windows Pro/Enterprise för att hantera lokala användare och grupper mer detaljerat än i den vanliga inställningsmenyn?

Vad är skillnaden mellan NTFS-behörigheterna "Full kontroll" (Full Control) och "Ändra" (Modify)?

Hur kan Event Viewer (Loggboken) hjälpa en tekniker att identifiera orsaken till att en dator plötsligt har startat om eller kraschat?

### Fördjupningslänkar

Microsoft (Hantera användarkonton i Windows) – https://support.microsoft.com/en-us/windows/manage-user-accounts-in-windows-10-104dc19f-6430-4b49-6a2b-e4dbd1dcdf32

Microsoft (Hur User Account Control - UAC fungerar) – https://learn.microsoft.com/en-us/windows/security/application-security/application-control/user-account-control/how-it-works

Microsoft (Översikt av Access Control och rättigheter) – https://learn.microsoft.com/en-us/windows/win32/secauthz/access-control-overview

How-To Geek (Använda Event Viewer för att felsöka problem) – https://www.howtogeek.com/123646/htg-explains-what-the-windows-event-viewer-is-and-how-you-can-use-it/

Microsoft (Felsökning med Task Manager) – https://support.microsoft.com/en-us/windows/how-to-use-task-manager-in-windows-10-86036815-5853-2d57-41fe-cfca5a9e334d

Lifewire (Guide till Computer Management-konsolen) – https://www.lifewire.com/how-to-open-computer-management-in-windows-2626076

Wikipedia (Access Control List - ACL förklarat) – https://en.wikipedia.org/wiki/Access-control_list

Microsoft (Skillnader mellan lokala konton och Microsoft-konton) – https://learn.microsoft.com/en-us/windows/security/identity-protection/access-control/local-accounts
...
---
**Nästa kapitel:** [6.6 Installation av Windows Server i fysisk maskin/VM](06.06_Installation_av_Windows_Server_i_fysisk_maskinVM.md)