---
layout: default
title: "7.4 Installation av Ubuntu Desktop"
parent: "Datorteknik"
nav_order: 704
---

# 7.4 Installation av Ubuntu Desktop
...
En LTS-version ges ut vartannat år (jämna år i april: 20.04, 22.04, 24.04…). Dessa har 5 års support, vilket innebär säkerhetsuppdateringar, buggfixar och stabilitet över lång tid. De används ofta i företag, skolor och produktion eftersom de är testade extra noggrant.

STS – Short Term Support

Släpps mellan LTS-versionerna (t.ex. 23.10, 24.10) och har 9 månaders support. Dessa versioner innehåller ofta nyare teknik och funktioner, vilket gör dem intressanta för utvecklare och entusiaster som vill ligga i framkant – men de är inte lika långsiktigt stabila som LTS.
...
### 7.4.1 Installation av Ubuntu Desktop i fysisk maskin/VM
...
#### 7.4.1.1 Förberedelser

Kontrollera systemkrav

Processor: 64-bitars, 1 GHz eller snabbareRAM: Minst 2 GB (4 GB eller mer rekommenderas)Lagring: Minst 25 GB (helst 40+ GB)UEFI med Secure Boot (Ubuntu fungerar med detta aktiverat)

#### 7.4.1.2 Ladda ner Ubuntu Desktop ISO
...
#### 7.4.1.3 Skapa en startbar USB-sticka
...
#### 7.4.1.4 Ändra bootordning i BIOS/UEFI
...
7.4.1.5 Installera Ubuntu Desktop
...
#### 7.4.1.6 Hantera MOK vid Secure Boot (valfritt)
...
#### 7.4.1.7 Kontrollera drivrutiner i efterhand
...
#### 7.4.1.8 Installera Ubuntu Desktop i virtuell maskin
...
Ubuntu Desktop Download (Officiell sida för att ladda ner installationsavbildningen) – https://ubuntu.com/download/desktop

Canonical (Företaget bakom Ubuntu och dess kommersiella support) – https://canonical.com

What is Secure Boot (Teknisk genomgång av hur Ubuntu fungerar med UEFI Secure Boot) – https://wiki.ubuntu.com/UEFI/SecureBoot

Installing Proprietary Drivers (Guide för installation av stängda drivrutiner för t.ex. Nvidia) – https://help.ubuntu.com/community/BinaryDriverHowto

Ubuntu LTS vs STS (Förklaring av Ubuntus olika releaser och livscykler) – https://ubuntu.com/blog/ubuntu-release-cycle-explained

BalenaEtcher (Rekommenderat verktyg för att skapa startbara USB-minnen) – https://www.balena.io/etcher/

Ubuntu Community Help (Samlad officiell dokumentation för installation och konfiguration) – https://help.ubuntu.com/
...
---
**Nästa kapitel:** [7.5 Konfiguration av Ubuntu Desktop](07.05_Konfiguration_av_Ubuntu_Desktop.md)