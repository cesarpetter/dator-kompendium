...
YAML---- name: Konfigurera VLAN på skolans switchar hosts: access_switchar

gather_facts: no tasks: - name: Skapa VLAN 10 med namnet Personal cisco.ios.ios_vlans: config: - name: Personal vlan_id: 10 state: merged
