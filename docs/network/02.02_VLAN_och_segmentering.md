...
Ett praktiskt exempel på en redundant miljö är två kärnswitchar som är sammankopplade med RSTP. Genom att konfigurera den ena som primär Root Bridge för hälften av nätverkets VLAN, och den andra som primär för den resterande hälften, utnyttjas nätverkets totala bandbredd effektivt samtidigt som full redundans bibehålls vid ett maskinfel.
